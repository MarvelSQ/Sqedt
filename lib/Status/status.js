...
function paraStyle(el) {
  ...
  return { color: color, fontSize: fontSize, lineHeight: lineHeight //,marginTop,marginLeft,marginRight,marginBottom,paddingTop,paddingLeft,paddingRight,paddingBottom};
  };
}
