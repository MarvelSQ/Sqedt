...
var Edt = function () {
  function Edt(element) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        callback = _ref$callback === undefined ? DEFULT_CALLBACK : _ref$callback;
  ...
  _createClass(Edt, [{
    ...
    value: function idGen() {
      if (!this.rootId) {
        this.rootId = 'edt' + Math.round(1000 + Math.random() * 999);
      }
      return this.rootId;
    }
  }, {
    ...
    value: function init() {
      ...
      this.el.setAttribute(this.idGen(), '');
    ...
    value: function command(_ref4) {
      ...
      if (level === 0) {
        if (type < 6) {
          ...
          [].concat(_toConsumableArray(_selection.origin.querySelectorAll('*'))).forEach(function (e) {
          ...
          if (_selection.type === 0) {
            ...
            [].concat(_toConsumableArray(_selection.origin.children)).forEach(function (para) {
              para.innerHTML = '<span style="' + _util2.default.camlToHypen(inlinelist[type]) + ':' + value + '"\'>' + para.innerHTML + '</span>';
            });
            _selection.range.deleteContents();
            var firstChild = _selection.origin.firstChild.children[0];
            var lastChild = _selection.origin.lastChild.children[0];
        ...
        if (_selection.type === 0) {
          ...
          var next = _selection.select.startContainer.nextElementSibling;
