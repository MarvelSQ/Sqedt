...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ES_index__ = __webpack_require__(126);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Status_status__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Drag_drag__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__HandleSelection_HandleSelection__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Template_template__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Format_format__ = __webpack_require__(333);
/**
 * 1.init element
 * 2.generate para
 *
...
class Edt {
  ...
  constructor(element, {format = false,callback = DEFULT_CALLBACK} = {}) {
    ...
    __WEBPACK_IMPORTED_MODULE_2__Drag_drag__["a" /* default */].init(this.el, __WEBPACK_IMPORTED_MODULE_5__Template_template__["a" /* default */].map,this.dragBack());
    this.format = format;
    this.callbacks = [];
  ...
  getDragin(){
    return __WEBPACK_IMPORTED_MODULE_2__Drag_drag__["a" /* default */].generateDragin(this);
  }
    ...
    document.addEventListener('selectionchange', e => {
      ...
      if (document.activeElement === this.el) {
        ...
        if (sl.rangeCount) {
          ...
          let tmp = __WEBPACK_IMPORTED_MODULE_3__HandleSelection_HandleSelection__["a" /* default */].handleSelection(sl);
          // let num = 0;
          // if (this.selection) {
          //   num = handleSl.compareSelection(this.selection, tmp);
          // }
          this.selection = tmp;
          this.alertUI({type:0,value:__WEBPACK_IMPORTED_MODULE_1__Status_status__["a" /* default */].computeStyle(tmp, this.el)});
        }
      }
    });
    this.formatDoc();
  ...
  formatDoc() {
    ...
    let [result,
      changed] = Object(__WEBPACK_IMPORTED_MODULE_6__Format_format__["a" /* default */])(this.el.innerHTML);
    if (changed) {
      this.el.innerHTML = '';
  ...
  editDoc() {
    ...
    __WEBPACK_IMPORTED_MODULE_2__Drag_drag__["a" /* default */].unbind();
  }

  editLayout() {
    this.status = 2;
    this.el.setAttribute('contenteditable', 'false');
    __WEBPACK_IMPORTED_MODULE_2__Drag_drag__["a" /* default */].bind();
    this.selection = undefined;
  }
  ...
  addTemplate({value,innerHTML,outer,callback}){
    __WEBPACK_IMPORTED_MODULE_5__Template_template__["a" /* default */].addTemplate({value,innerHTML,outer,callback});
  }
      ...
      if (type < 6) {
        ...
        [..._selection.origin.querySelectorAll('*')].forEach(e => {
          ...
          if (e.nodeName === 'SPAN' && !e.style[0]) {
            __WEBPACK_IMPORTED_MODULE_4__util__["a" /* default */].replaceWidthChild(e);
          }
        })
        if (_selection.type === 0) {
          ...
          [..._selection.origin.children].forEach(para => {
            para.innerHTML = `<span style="${__WEBPACK_IMPORTED_MODULE_4__util__["a" /* default */].camlToHypen(inlinelist[type])}:${value}"'>${para.innerHTML}</span>`
          })
          _selection.range.deleteContents();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util__ = __webpack_require__(124);
